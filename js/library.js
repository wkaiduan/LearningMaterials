/**
 * Created by doudou on 2018/7/17.
 */
...
/*
 * æ‡’äººCSS Bate V0.10
 * ä½œè€…ï¼šæ‡’äººå»ºç«™ http://www.51xuediannao.com/
 * 2015-02-04â€”â€”â€”
 * å¤æ‚åŠŸèƒ½ï¼Œå»ºè®®ä½¿ç”¨ä¼˜ç§€çš„å¼€æºæ’ä»¶ã€‚js/pluginsé¢„ç½®äº†ä¸€äº›å¸¸ç”¨çš„ä¼˜ç§€æ’ä»¶
 * jquery.jsæ˜¯å¿…é¡»çš„
 */
...
tools.webStatus = function (statusCode) {
    var code = {
        200: "200 -> è¯·æ±‚æˆåŠŸ",
        302: "302 -> ä¸´æ—¶è·³è½¬",
        404: "404 -> è¯·æ±‚åœ°å€é”™è¯¯",
        505: "505 -> è¯·æ£€æŸ¥æœåŠ¡ç«¯"
    };
...
tools.data2html = function (tpl, data) {
    //éœ€è¦ js/plugins/template/doT.min.js æ”¯æŒ
...
/*
 çª—ä½“æ”¹å˜(scroll resize)å»¶æ—¶æ‰§è¡Œäº‹ä»¶
 ç¤ºä¾‹ï¼š
 tools.TimeOutRun($(window),"scroll",runFun,2000);	//TimeOutRun(äº‹ä»¶,è¦è¿è¡Œçš„å‡½æ•°å,é—´éš”æ—¶é—´)
 function runFun(){ alert("å“ˆå“ˆ") }
 */
...
//jsåŠ¨æ€æ’å…¥cssæˆ–è€…jsæ–‡ä»¶
//tools.loadJs("css/base.js",callback,[["attr1","xx"],["attr2","yy"]])
tools.loadJs = function (filename, callback, attrArr) {
    var fileRef = document.createElement('script');         //åˆ›å»ºæ ‡ç­¾
    fileRef.type = "text/javascript";   //å®šä¹‰å±žæ€§typeçš„å€¼ä¸ºtext/javascript
    fileRef.src = filename;              //æ–‡ä»¶çš„åœ°å€
    if (attrArr) {
...
tools.date = {
    /**
     * æ—¥æœŸæ ¼å¼åŒ–
     * format æ ¼å¼åº”ä¸º "YYYY-MM-DD hh:mm:ss S q" è¿™æ ·çš„ç»„åˆ
     * å¯ä»¥ä¼ å…¥ æŒ‡å®šæ—¥æœŸï¼Œå¦‚ï¼š"2018/07/8 18:45:13"
     */
    ...
    //èŽ·å–å¹´æœˆæ—¥  å¯ä»¥ä¼ dates å¾€å‰+ æˆ– å¾€åŽ- å¾—åˆ°æœ€ç»ˆæ—¥æœŸ
    ...
    //æœ¬å‘¨ä¸€ä¸Žå½“å‰æ—¥æœŸç›¸å·®çš„å¤©æ•°  monday
    getMonday: function () {
        var d = new Date();
        //å‘¨
        var day = d.getDay();
        return (day != 0) ? day - 1 : 6; // æœ¬å‘¨ä¸€ä¸Žå½“å‰æ—¥æœŸç›¸å·®çš„å¤©æ•°  monday
    }
};

//æµè§ˆå™¨ç‰ˆæœ¬åˆ¤æ–­ ç¤ºä¾‹ï¼štools.Browser().chrome  //  $lr().Browser().ver
...
tools.scrollDirection = function(e){
    ...
    var scrollFunc = function (e) {
        e = e || window.event;
        if (e.wheelDelta) {  //åˆ¤æ–­æµè§ˆå™¨IEï¼Œè°·æ­Œæ»‘è½®äº‹ä»¶
...
$.fn.extend({
    ...
    //ç®€å•çš„tab $("å¤–å±‚ID").simTab("äº‹ä»¶","å»¶æ—¶","å›žè°ƒ")
